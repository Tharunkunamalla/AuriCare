  ...
  return (
    <main className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          name="description"
          content="AuriCare — calm, data‑driven autism support: therapy tracking, AI assistant, caregiver tools."
        />
      ...
      <section className="container mx-auto py-20 md:py-28">
        <div className="mx-auto max-w-5xl text-center animate-enter">
          ...
          <h1 className="mt-6 font-heading text-4xl md:text-6xl font-semibold tracking-tight">
            AuriCare — A Gift to God's Children
          </h1>
          <p className="mt-4 text-lg md:text-xl text-muted-foreground">
            Track therapy progress, chat with Auri, schedule routines, and
            access calming sensory tools — all in one secure, accessible
            platform.
          </p>
      ...
      <section className="container mx-auto py-10 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="hover-scale">
            <CardContent className="pt-6">
              ...
              <p className="mt-2 text-muted-foreground">
                Safe, multi‑turn Q&A for behavior strategies, routines, and
                emergency guidance.
              </p>
            </CardContent>
          </Card>
          <Card className="hover-scale">
            <CardContent className="pt-6">
              ...
              <p className="mt-2 text-muted-foreground">
                Log sessions and visualize milestones across skills with
          ...
          <Card className="hover-scale">
            <CardContent className="pt-6">
              ...
              <h2 className="mt-3 font-semibold text-xl">
                Daily Visual Scheduler
              </h2>
              <p className="mt-2 text-muted-foreground">
                Build pictogram‑based routines with timers and caregiver
                notifications.
              </p>
            </CardContent>
          </Card>
        ...
        <div className="mt-10 text-center">
          <Link to="/features" className="story-link">
      ...
      <section className="container mx-auto py-14 md:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-2 text-muted-foreground">
            WCAG 2.1 AA, role‑based access, and HIPAA/GDPR‑ready policies. Your
            family’s data is protected with care.
          </p>
        </div>
      </section>
    </main>
